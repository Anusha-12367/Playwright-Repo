...
```
Error: locator.click: Error: strict mode violation: locator('.close') resolved to 4 elements:
    1) <button type="button" class="close" aria-label="Close" data-dismiss="modal">…</button> aka getByLabel('New message').getByLabel('Close')
    2) <button type="button" class="close" aria-label="Close" data-dismiss="modal">…</button> aka getByRole('dialog', { name: 'Sign up' }).getByLabel('Close')
    3) <button type="button" class="close" aria-label="Close" data-dismiss="modal">…</button> aka getByLabel('Log in').getByLabel('Close')
    4) <button type="button" class="close" aria-label="Close" data-dismiss="modal">…</button> aka locator('#videoModal').getByLabel('Close')

Call log:
  - waiting for locator('.close')
...
```ts
  ...
  9  |     this.closeb=page.locator('.close')
  10 |    }
  11 | async goto(){   
